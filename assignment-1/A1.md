...
One way to fix this, connect the Switch0 to GigabitEthernet0/0/0 interface of the router and PC1/Laptop0 will be able to acquire their configuration through DHCP.
